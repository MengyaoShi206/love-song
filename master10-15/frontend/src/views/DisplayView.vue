      ...
      <aside class="sidebar">
        <el-card class="sidebar-card" shadow="never">
          ...
          <el-menu :default-active="'display'" class="pretty-menu" @select="onSelect" :router="false">
            ...
            <el-menu-item index="match"><el-icon><User /></el-icon><span>匹配资料展示</span></el-menu-item>
            <el-menu-item index="other" disabled><el-icon><Setting /></el-icon><span>其他（待扩展）</span></el-menu-item>
          </el-menu>
        </el-card>
      </aside>
